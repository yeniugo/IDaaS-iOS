...
//        UIAlertController *alertVC =  [UIAlertController alertControllerWithTitle:[NSString stringWithFormat:@"%@",url] message:[NSString stringWithFormat:@"%@",options] preferredStyle:UIAlertControllerStyleAlert];
//
//
