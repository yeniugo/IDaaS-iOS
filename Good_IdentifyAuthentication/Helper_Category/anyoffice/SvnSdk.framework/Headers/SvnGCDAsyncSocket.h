...
#define GCDAsyncSocketPreBuffer  SvnGCDAsyncSocketPreBuffer
#define GCDAsyncWritePacket   SvnGCDAsyncWritePacket
#define GCDAsyncReadPacket   SvnGCDAsyncReadPacket
#define GCDAsyncSpecialPacket SvnGCDAsyncSpecialPacket
#define GCDAsyncSocket  SvnGCDAsyncSocket

#define cfstreamThreadRetainCount SvncfstreamThreadRetainCount
#define cfstreamThreadSetupQueue SvncfstreamThreadSetupQueue
#define cfstreamThread SvncfstreamThread
#define GCDAsyncSocketException  SvnGCDAsyncSocketException
#define GCDAsyncSocketErrorDomain SvnGCDAsyncSocketErrorDomain
#define GCDAsyncSocketQueueName  SvnGCDAsyncSocketQueueName
#define GCDAsyncSocketThreadName SvnGCDAsyncSocketThreadName
#define GCDAsyncSocketManuallyEvaluateTrust SvnGCDAsyncSocketManuallyEvaluateTrust
#if TARGET_OS_IPHONE
#define GCDAsyncSocketUseCFStreamForTLS  SvnGCDAsyncSocketUseCFStreamForTLS
#endif

#define GCDAsyncSocketSSLPeerID SvnGCDAsyncSocketSSLPeerID
#define GCDAsyncSocketSSLProtocolVersionMin  SvnGCDAsyncSocketSSLProtocolVersionMin
#define GCDAsyncSocketSSLProtocolVersionMax  SvnGCDAsyncSocketSSLProtocolVersionMax
#define GCDAsyncSocketSSLSessionOptionFalseStart SvnGCDAsyncSocketSSLSessionOptionFalseStart
#define GCDAsyncSocketSSLSessionOptionSendOneByteRecord SvnGCDAsyncSocketSSLSessionOptionSendOneByteRecord
#define GCDAsyncSocketSSLCipherSuites  SvnGCDAsyncSocketSSLCipherSuites
#if !TARGET_OS_IPHONE
#define GCDAsyncSocketSSLDiffieHellmanParameters  SvnGCDAsyncSocketSSLDiffieHellmanParameters
#endif

#define GCDAsyncSocketFlags  SvnGCDAsyncSocketFlags
#define GCDAsyncSocketConfig  SvnGCDAsyncSocketConfig

#define GCDAsyncSocketError SvnGCDAsyncSocketError
#define GCDAsyncSocketNoError SvnGCDAsyncSocketNoError
#define GCDAsyncSocketBadConfigError  SvnGCDAsyncSocketBadConfigError
#define GCDAsyncSocketBadParamError SvnGCDAsyncSocketBadParamError
#define GCDAsyncSocketConnectTimeoutError SvnGCDAsyncSocketConnectTimeoutError
#define GCDAsyncSocketReadTimeoutError SvnGCDAsyncSocketReadTimeoutError
#define GCDAsyncSocketWriteTimeoutError SvnGCDAsyncSocketWriteTimeoutError
#define GCDAsyncSocketReadMaxedOutError SvnGCDAsyncSocketReadMaxedOutError
#define GCDAsyncSocketClosedError SvnGCDAsyncSocketClosedError
#define GCDAsyncSocketOtherError SvnGCDAsyncSocketOtherError

#define _useL4VPN true

@class SvnGCDAsyncReadPacket;
@class SvnGCDAsyncWritePacket;
@class SvnGCDAsyncSocketPreBuffer;
...
typedef NS_ENUM(NSInteger, SvnGCDAsyncSocketError) {
	SvnGCDAsyncSocketNoError = 0,           // Never used
	SvnGCDAsyncSocketBadConfigError,        // Invalid configuration
	SvnGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	SvnGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	SvnGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	SvnGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	SvnGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	SvnGCDAsyncSocketClosedError,           // The remote peer closed the connection
	SvnGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface SvnGCDAsyncSocket : NSObject
...
//added for l4vpn
//@property (atomic, readwrite) Boolean useL4VPN;
@property (atomic, readwrite) Boolean startProcStream;
@property (atomic, readwrite) Boolean readDone;
 ...
 * but your socket gets_s directed to MaliciousServer.com because of a hacked DNS server.
...
@protocol SvnGCDAsyncSocketDelegate
@optional
