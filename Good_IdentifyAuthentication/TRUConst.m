...
NSString *kMicrophoneFailedTip = @"请在iPhone的“设置-隐私-麦克风”选项中，允许蓝证访问您的手机麦克风";
NSString *kCameraFailedTip = @"请在iPhone的“设置-隐私-相机”选项中，允许蓝证访问您的相机";
NSString *kPhotoAlbumFailedTip = @"请在iPhone的“设置-隐私-相册”选项中，允许蓝证访问您的手机相册";
