...
NSString *kMicrophoneFailedTip = @"请在iPhone的“设置-隐私-麦克风”选项中，允许芯盾认证访问您的手机麦克风";
NSString *kCameraFailedTip = @"请在iPhone的“设置-隐私-相机”选项中，允许芯盾认证访问您的相机";
NSString *kPhotoAlbumFailedTip = @"请在iPhone的“设置-隐私-相册”选项中，允许芯盾认证访问您的手机相册";
...
//NSString *kServerUrl = @"http://192.168.1.115:8000/cims";
//NSString *kServerUrl = @"http://192.168.1.99:8000/cims";
