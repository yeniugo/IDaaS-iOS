...
- (void)drawTextInRect:(CGRect)rect{
    ...
    // 画矩形边框
    for (int i = 1; i < self.numberOfVertificationCode; i++) {
        // 计算每位验证码/密码的绘制区域
...
//        CGContextAddPath(context, bezierPath.CGPath);
        ...
        [bezierPath moveToPoint:tempRect.origin];
        [bezierPath addLineToPoint:CGPointMake(tempRect.origin.x, tempRect.size.height)];
        CGContextAddPath(context, bezierPath.CGPath);
