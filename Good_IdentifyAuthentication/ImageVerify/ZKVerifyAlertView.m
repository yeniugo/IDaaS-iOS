...
- (void)setupContentView
{
    ...
    [_contentView addSubview:({
        ...
        _slider.minimumTrackTintColor = [UIColor colorWithRed:1 green:0 blue:0 alpha:1.00];
        _slider.maximumTrackTintColor = [UIColor colorWithRed:0.90 green:0.90 blue:0.90 alpha:1.00];
        [_slider setMinimumTrackImage:[UIImage ly_imageWithFillColor:DefaultGreenColor lineColor:[UIColor clearColor] Size:CGSizeMake(20, 35)] forState:UIControlStateNormal];
        [_slider setMaximumTrackImage:[UIImage ly_imageWithFillColor:[UIColor clearColor] lineColor:[UIColor lightGrayColor] Size:CGSizeMake(20, 35)] forState:UIControlStateNormal];
...
- (void)updateLayout:(BOOL)animated
{
    ...
    _slider.frame = CGRectMake(margin, sliderY, safeWidth, 40.f);
