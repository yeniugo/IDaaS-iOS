...
//            [weakSelf hideHudDelay:0.0];
            if (errorno == 0) {
                ...
                dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.6 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                    ...
                    if (delegate.urlstr.length) {
                        delegate.urlstr = @"http://10.10.204.90:8100/authn/2.html";
                        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:delegate.urlstr] options:nil completionHandler:^(BOOL success) {
                            if (success) {
                                delegate.token = nil;
                                delegate.urlstr = nil;
                            }
