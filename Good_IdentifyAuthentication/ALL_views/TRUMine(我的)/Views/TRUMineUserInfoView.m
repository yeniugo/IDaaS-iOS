...
-(void)setModel{
    ...
    if ([userModel.realname containsString:@"#"]) {
        NSArray *arr = [userModel.realname componentsSeparatedByString:@"#"];
        if (arr.count>0) {
    ...
    if ([userModel.department containsString:@"#"]) {
        NSArray *arr = [userModel.department componentsSeparatedByString:@"#"];
        if (arr.count>0) {
            self.departmentLabel.text = arr[0];
        }else{
