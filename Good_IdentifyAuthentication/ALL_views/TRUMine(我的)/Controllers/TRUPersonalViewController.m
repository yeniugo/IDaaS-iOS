...
- (void)viewDidLoad {
    ...
    self.imageArray = @[@[@"PersonalFace"],@[@"editPhone"],@[@"PersonalSafe"],@[@"PersonalDevice"],@[@"PersonalAboutUS"]];
    self.titleArray = @[@[@"人脸信息"],@[@"修改手机号"],@[@"APP安全验证"],@[@"设备管理"],@[@"版本信息"]];
    self.commitArray =  @[@[@"TRUPersonalDetailsViewController"],@[@"TRUFaceSettingViewController"],@[@"TRUPhoneViewController"],@[@"TRUAPPLogIdentifyController"],@[@"TRUDevicesManagerController"],@[@"TRUAboutUsViewController"]];
}
...
//            //                phone = @"";
//            //            }
//            smallCell.detailMessageLB.text = phone;
//        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([classStr isEqualToString:@"TRUPhoneViewController"]) {
