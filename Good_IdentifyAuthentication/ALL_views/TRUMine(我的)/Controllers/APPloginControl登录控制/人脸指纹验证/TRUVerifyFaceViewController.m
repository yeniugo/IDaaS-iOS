...
- (void)customUI{
    ...
    if (self.isDoingAuth && [TRUFingerGesUtil getLoginAuthGesType] == TRULoginAuthGesTypeture) {
        ...
        [otherModeBtn setTitleColor:RGBCOLOR(75,110,174) forState:UIControlStateNormal];
        ...
        [agreementBtn setTitleColor:RGBCOLOR(75,110,174) forState:UIControlStateNormal];
