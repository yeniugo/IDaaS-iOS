...
#import "TRUVoiceNumberLabel.h"

@implementation TRUVoiceNumberLabel
...
//        int counti = i > 4 ? (i -1) : i;
        ...
        if (i >= 4) {
            // 计算每位验证码/密码的绘制区域
            tempRect = CGRectMake(i * (width +self.spacing )+ self.midSpacing + self.lineWidth, self.lineWidth, width - self.lineWidth*2, height - self.lineWidth*2);
