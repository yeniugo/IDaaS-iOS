...
//                [xindunsdk initEnv:@"com.example.demo" url:currentCims];
                bool res = [xindunsdk initCIMSEnv:@"com.example.demo" serviceUrl:currentCims devfpUrl:currentCims];
//                [HAMLogOutputWindow printLog:[NSString stringWithFormat:@"初始化 %d",res]];
...
//                [HAMLogOutputWindow printLog:[NSString stringWithFormat:@"参数 %@",para]];
                NSDictionary *dic = @{@"params" : [NSString stringWithFormat:@"%@",para]};
//                [HAMLogOutputWindow printLog:[NSString stringWithFormat:@"cims = %@",currentCims]];
...
//                    [HAMLogOutputWindow printLog:[NSString stringWithFormat:@"error = %d",errorno]];
                    if (errorno == 0 && responseBody) {
                        NSDictionary *dict = [xindunsdk decodeServerResponse:responseBody];
                        YCLog(@"--->%@",dict);
//                        [HAMLogOutputWindow printLog:dict.description];
